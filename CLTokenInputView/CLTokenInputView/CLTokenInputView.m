...
static CGFloat const STANDARD_ROW_HEIGHT = 32.0;
...
- (void)addToken:(CLToken *)token
{
	...
	CLTokenView *tokenView = [[CLTokenView alloc] initWithToken:token
														   font:self.font
										   tokenBackgroundColor:self.tokenBackgroundColor
												 tokenTextColor:self.tokenTextColor
									 tokenBackgroundActiveColor:self.tokenBackgroundActiveColor
										   tokenTextActiveColor:self.tokenTextActiveColor];
